...
public class EmployeeController {
    ...
    @ApiOperation(value = "Get the employee list by page",
    		notes = "pageIndex start from 1, pageSize shoud be greater than 0")
    @GetMapping("/employees")
    public Page<Employee> getEmployees(@RequestParam(required = false) Integer pageIndex, @RequestParam(required = false) Integer pageSize) {
